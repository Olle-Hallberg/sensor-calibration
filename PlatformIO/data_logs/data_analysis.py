...
date_time = '20260511_211806'

### dataframe ###
df = pd.read_csv('data_logs/sensor_log_' + date_time + '.csv')
...
# Labels and more
ax11.set_xticks(np.arange(0, df.shape[0] + 1, 1))
...
# Labels and more
ax21.set_xticks(np.arange(0, df.shape[0] + 1, 1))
...
for ax in [ax21, ax22, ax23]:
    ...
    handles += h
    labels += l
ax23.legend(handles, labels, loc='lower right', framealpha=0.25)
